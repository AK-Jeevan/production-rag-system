...
class TestGeminiGenerator:
    @patch("src.generation.generator.genai.GenerativeModel")
    ...
    @patch("src.generation.generator.genai.GenerativeModel")
    def test_invalid_model_key_falls_back(self, mock_model):
        from src.generation.generator import GeminiGenerator
    ...
    @patch("src.generation.generator.genai.GenerativeModel")
    def test_generate_answer_success(self, mock_model):
        from src.generation.generator import GeminiGenerator
    ...
    @patch("src.generation.generator.genai.GenerativeModel")
    def test_generate_answer_empty_prompt_raises(self, mock_model):
        from src.generation.generator import GeminiGenerator
    ...
    @patch("src.generation.generator.genai.GenerativeModel")
    def test_generate_answer_stream_yields_chunks(self, mock_model):
        from src.generation.generator import GeminiGenerator

        chunk1, chunk2 = MagicMock(), MagicMock()
        chunk1.text = "Hello "
        chunk2.text = "World"
        mock_model.return_value.generate_content.return_value = [chunk1, chunk2]
    ...
    @patch("src.generation.generator.genai.GenerativeModel")
    def test_generate_rag_answer_empty_context_raises(self, mock_model):
        from src.generation.generator import GeminiGenerator
    ...
    @patch("src.generation.generator.genai.GenerativeModel")
    def test_list_available_models(self, mock_model):
        from src.generation.generator import GeminiGenerator

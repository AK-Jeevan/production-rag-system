...
if __name__ == "__main__":
    ...
    docs = [
        ...
        Document(page_content="FAISS is used for similarity search.",           metadata={"source": "faiss.md"}),
        Document(page_content="DVC versions data and ML pipelines.",            metadata={"source": "dvc.md"}),
    ]
